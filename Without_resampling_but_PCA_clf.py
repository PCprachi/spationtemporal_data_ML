...
# Read the data from a CSV file or your data source
data = pd.read_csv('/home/sumit/Downloads/prachi/Classification/merged_df.csv')  

# Define bins and labels for visibility categories
bins = [-float('inf'), 0, 5, 10, float('inf')]  # Define your own bin ranges
labels = ['very low visibility', 'low visibility', 'medium visibility', 'high visibility']

# Create a new column with categorical visibility labels based on binning
...
# Apply SMOTE only on the validation set
